...
public class AboutFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button b = v.findViewById(R.id.ssid);
    ...
    public Animation onCreateAnimation(int transit, boolean enter, int nextAnim) {
        ...
        if (enter && !(transit == 17432576)) {
            return new ExpandViewAnimation(getView()
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View parent) {
            ...
            bssid = parent.findViewById(R.id.bssid);
            capabilities = parent.findViewById(R.id.capabilities);
            frequency = parent.findViewById(R.id.frequency);
            level = parent.findViewById(R.id.level);
        }
